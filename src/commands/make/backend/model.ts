  ...
  protected steps(stepManager: StepManager<FlarumProviders>): StepManager<FlarumProviders> {
    return stepManager.atomicGroup((stepManager) => {
      stepManager
        ...
        .namedStep(
          'validator',
          new GenerateValidatorStub(this.STUB_PATH, genExtScaffolder()),
          { optional: true, confirmationMessage: 'Generate corresponding Validator?', default: true },
          [
            {
              sourceStep: 'model',
              exposedName: 'className',
        ...
        .namedStep(
          'repository',
          new GenerateRepositoryStub(this.STUB_PATH, genExtScaffolder()),
          { optional: true, confirmationMessage: 'Generate corresponding Repository?', default: true },
          [
            {
              sourceStep: 'model',
              exposedName: 'class',
