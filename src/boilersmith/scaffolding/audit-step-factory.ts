...
export function auditStepFactory<MN extends string, Providers extends DefaultProviders>(dry: boolean, scaffoldDir: string, modules: Module<MN>[], templateParams: TemplateParam[], moduleStatusCache?: ModuleStatusCache<MN>): Step<Providers> {
