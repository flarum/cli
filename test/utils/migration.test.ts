...
describe('getNextMigrationName', function () {
  ...
  test('migrations on other days dont affect number', function () {
    const existingMigrations = ['1995_02_20_123456_something.php', '2001_01_01_000000_test.php', '2083_06_17_666666_migration.php'];
  ...
  test('migrations on same day result in number being one above greatest', function () {
    const existingMigrations = ['2020_01_01_000000_something.php', '2020_01_01_012345_test.php', '2020_01_01_999998_migration.php'];
